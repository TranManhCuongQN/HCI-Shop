...
const createCustomShadow = (isDark: boolean) => {
  const color = isDark ? DARK_MODE : LIGHT_MODE;
...
export const customShadows = (isDark: boolean) => createCustomShadow(isDark);

const shadows = (isDark: boolean) => createShadow(isDark);
